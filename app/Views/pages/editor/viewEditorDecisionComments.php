			...
			<div id="main">
				...
				<div id="content">
					...
					<?php if (isset($editorToAuthor)) : ?>
						<?php foreach ($editorToAuthor as $comment) : ?>
								...
								<table class="data" width="100%">
									<div id="comment">
										<tr valign="top">
											...
											<td width="75%">
												<div style="float: right"><a href="<?= base_url(); ?>/editor/deleteComment/<?= $article_id; ?>" onclick="return confirm('Apakah anda yakin menghapusnya?')" class="action">Delete</a></div>
												<div id="6091"></a>
					...
					<form method="post" action="<?= base_url(); ?>/editor/postEditorDecisionComment">
