...
<tr valign="top">
	...
	<td class="value">
		...
		<a href="/editor/viewEditorDecisionComments/<?= $article['article_id']; ?>" class="icon"><img src="https://iptek.its.ac.id/lib/pkp/templates/images/icons/comment.gif" width="16" height="14" alt="Comment" /></a>No Comments
		<?php if(isset($decision_editor)) : ?>
			<?php if(isset($review_version)) : ?>
