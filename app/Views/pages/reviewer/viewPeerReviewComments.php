...
<head>
  ...
  <script language="javascript" type="text/javascript">
    tinyMCE.init({
      ...
      mode: "exact",
      language: "en",
      elements: "authorComments,comments",
      relative_urls: false,
    ...
    <div id="body">
      <div id="main">
        ...
        <div id="content">
          ...
          <!-- $editorToAuthor change to $comments -->
            ...
            <div id="new">
              ...
              <table class="data" width="100%">
                <!-- <tr valign="top">
                  ...
                  <td class="value"><input type="text" name="commentTitle" id="commentTitle" value="tesdt" size="50" maxlength="255" class="textField" /></td>
                </tr> -->
                <tr valign="top">
                  <td class="label">
                  ...
                  <td class="value"><textarea id="authorComments" name="authorComments" rows="10" cols="50" class="textArea"></textarea></td>
                </tr>
                <tr valign="top">
                  <td class="label">
                    <label for="comments">
